...
class UpcomingMovies extends Component {
  ...
  getData = async (page = 1) => {
    const url =
      'https://api.themoviedb.org/3/movie/upcoming?api_key=420ad37b4f6d8933c4ce36c51bb59790&language=en-US&page=1'
    ...
    this.setState({isLoader: false, moviesResponse: updatedData})
  }
    ...
    return (
      <>
        <div className="main-container">
          {isLoader ? this.renderLoadingView() : this.renderMoviesList()}
        </div>
        <Pagination
